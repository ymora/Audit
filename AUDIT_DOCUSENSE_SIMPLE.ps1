# ===============================================================================
# AUDIT DOCUSENSE AI V2 - VERSION SIMPLE
# ===============================================================================
...
$docSenseModules = @{
    ...
    "UI/UX" = "Checks-UI.ps1"
    "Qualité Code" = "Checks-CodeMort.ps1"
    ...
    "DocSense Spécifique" = "Checks-DocSenseSpecific.ps1"
...
$outputPath = Join-Path $PSScriptRoot "resultats\DOCUSENSE_SPECIFIC_$(Get-Date -Format 'yyyyMMdd_HHmmss').json"
...
Write-Host "  Amélioration: +$([math]::Round($globalScore - 7.2, 1)) points" -ForegroundColor Green
